...
Parallel symmetric eigenvalues (eigh / psd_project)
----------------------------------------------------

Compile-time-sized symmetric eigendecomposition via round-robin parallel
Jacobi sweeps (``eigh``), plus the positive-semidefinite projection
``psd_project``. Prefer this family when its compile-time-size contract fits;
benchmark it against ``syev`` for the target matrix sizes.

.. doxygenfile:: src/base/L3/eigh.cuh
   :no-link:
