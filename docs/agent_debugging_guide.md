...
- **The fix / the rule:** every phase boundary that crosses threads needs a barrier. Look at the
  ...
  3-matrix invert is TRAJOPT-SOLVER's Schur kernel, Q_k/Q_kp1/R_k). They interleave K independent matrices'
...
This is exactly how RBD-SOLVER's generated RNEA NaN'd (2026-07-08): the v/a forward-pass gemvs write cold
...
- **The historical tell (if you ever see it again):** a discrepancy that is thread-count-dependent,
  ...
  arena to prove it (see RBD-SOLVER/PDDP heavy-robustness notes).
