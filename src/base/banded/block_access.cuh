 ...
 * Consumers (e.g. TRAJOPT-SOLVER's Schur assembly) repeatedly hand-roll the transpose /
 ...
 * TRAJOPT-SOLVER's `phi_k` vs `phi_kᵀ`). `scale` folds in a multiplier (`-1` negates, TRAJOPT-SOLVER's
