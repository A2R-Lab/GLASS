...
// stack carries some version of these (cuRobo's pose_distance kernels, TRAJOPT-SOLVER's
// EE goal costs, IK-SOLVER's orientation residual) with silently different sign
...
//     written as `log(q_des ⊗ q⁻¹)` — e.g. IK-SOLVER's — is
