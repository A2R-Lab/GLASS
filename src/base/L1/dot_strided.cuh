...
// (e.g., RBD-SOLVER generated kernels where the outer loop is already thread-parallel).
 ...
 * (e.g. RBD-SOLVER generated kernels). With `SX = SY = 1` this is a plain scalar dot;
