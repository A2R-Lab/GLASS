...
def test_gemm_rt_betaform_beta0_no_read(bins, m, n, k, ta, tb):
    ...
    for the RBD-SOLVER s_vaf uninit-smem NaN (2026-07-08); the (16,4,8) shape takes
    the tile4 fast path."""
    alpha = 1.5
...
# (12,12,6) mirrors TRAJOPT-SOLVER's Schur fused-3 (STATE_SIZE=12, CONTROL_SIZE=6 for indy7)
@pytest.mark.parametrize("threads", THREAD_SWEEP_CORE)
