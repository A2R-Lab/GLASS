...
# blend computes 0*NaN=NaN). Regression for the RBD-SOLVER s_vaf uninit-smem NaN
...
# beta==0 write-only semantics for the segmented beta form — THE RBD-SOLVER RNEA shape
