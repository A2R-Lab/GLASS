...
Replaces TRAJOPT-SOLVER's hand-rolled Schur remap loops. The index map (verified against
bdmv.cuh's row-major strip and TRAJOPT-SOLVER schur_linsys.cuh):
...
def test_trajopt_solver_schur_patterns(bins):
    """The exact TRAJOPT-SOLVER patterns: phi_kᵀ (direct), phi_k (transpose), theta negate.
